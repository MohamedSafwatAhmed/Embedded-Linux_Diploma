...
for i in range(numpies):
    cnvs.create_arc(coord, start=(i*15+30), extent=(120/numpies), fill="white",  width=1)    
...
cnvs.create_text(340,140,font="Times 12 bold", text=hi_r)
id_text = cnvs.create_text(170,235,font="Times 15 bold")
